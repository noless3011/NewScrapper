...
public class AdvanceSearch {
    ...
    public List<Tweet> searchAdvanceTweet(String inputTitle, String inputAuthor, DateRange range, String inputContent, List<String> inputHashtag) throws ParseException, IOException {
        try {
    ...
    public List<Article> searchAdvanceArticle(String inputTitle, String inputAuthor, DateRange range, String inputContent) throws ParseException, IOException {
        try {
    ...
    public List<Facebook> searchAdvanceFacebook(String inputTitle, String inputAuthor, DateRange range, String inputContent) throws ParseException, IOException {
        try {
