...
public class Arrange {
	...
	public List<Tweet> arrangeTweet(List<Tweet> tweets, SortOptionTweet option, boolean direction) {
		...
		case TIME:
			comparator = Comparator
					.comparingLong(tweet -> DateRange.formatterTimeToEpochSecond(tweet.getPublishedAt()));
			break;
		case LIKE:
	...
	public List<Facebook> arrangeFacebook(List<Facebook> facebooks, SortOptionFacebook option, boolean direction) {
		...
		case TIME:
			comparator = Comparator
					.comparingLong(facebook -> DateRange.formatterTimeToEpochSecond(facebook.getPublishedAt()));
			break;
		case REACTION:
